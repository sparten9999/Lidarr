...
[Files]
Source: "..\_artifacts\windows\Lidarr\Lidarr.exe"; DestDir: "{app}"; Flags: ignoreversion  
Source: "..\_artifacts\windows\Lidarr\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
